...
plot_cluster_count_medians_and_quartiles <- function(data, quartiles_percent = 0.5, legend.pos = "right"){            
...
```{r}
syllables_mq <- plot_diversity_medians_and_quartiles(data_syllables, legend.pos = c(1, 0.2))

add_generational_success_counts_plot(data_syllables, syllables_mq)
