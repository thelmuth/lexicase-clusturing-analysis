...
Let's try using Manhattan distance instead of Euclidean distance.
...
Let's try apcluster with Manhattan distances. (I think I did this right, though I'm not sure.)
